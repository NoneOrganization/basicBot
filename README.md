...
`javascript:(function(){$.getScript('https://rawgit.com/NoneOrganization/basicBot/master/basicBot.js');})();`

If this does not work, go to https://raw.githubusercontent.com/NoneOrganization/basicBot/master/basicBot.js and copy paste its content into your console (accessible in chrome by pressing f12) when on plug.dj in your community.
